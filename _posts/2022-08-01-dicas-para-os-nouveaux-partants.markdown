...
Dicas de sobrevivência no país do Macaron
...
- [ ] Iniciar o processo para obter a _[Carte Vitale](http://www.etudiant-etranger.ameli.fr/)_
...
- [ ] Fazer um planejamento de todo o trajeto até o destino final
...
- [ ] Ter alguns Euros em especies para emergências
...
- [ ] Providenciar uma tradução juramentada da certidão de nascimento
...
- [ ] Descansar e começar a se adaptar ao novo fuso horário 
- [ ] Fazer a validação do visto
...
- [ ] Iniciar o processo da CAF e outros auxílios para estudantes
...
- [ ] Fazer um _forfait_ para celular
...
- [ ] Participem da semana de integração
